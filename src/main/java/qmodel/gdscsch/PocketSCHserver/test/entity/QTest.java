package gdscsch.PocketSCHserver.test.entity;
...
public class QTest extends EntityPathBase<Test> {
    ...
    private static final long serialVersionUID = 1525579661L;

    public static final QTest test = new QTest("test");

    public final StringPath testContents = createString("testContents");
